...
from .serializers import CommentReactionUpdateSerializer, PostCommentUpdateSerializer, PostReactionUpdateSerializer, PostSerializer,PostCreateSerializer,PostDetailSerializer,PostMediaCreateSerializer,PostMediaSerializer,PostCommentCreateSerializer,PostCommentSerializer,PostReactionCreateSerializer,PostReactionSerializer,CommentReactionCreateSerializer,CommentReactionSerializer
...
@authentication_classes([TokenAuthentication, BasicAuthentication, SessionAuthentication])
@permission_classes([IsAuthenticated])
class PostCommentViewSet(CreateModelMixin,RetrieveModelMixin,UpdateModelMixin,DestroyModelMixin,GenericViewSet):
    ...
    def reactions(self,request,pk=None):
        ...
        serializer =CommentReactionSerializer(reactions,many=True,context={'request':request})

        return serializer.data
@authentication_classes([TokenAuthentication, BasicAuthentication, SessionAuthentication])
@permission_classes([IsAuthenticated])
class CommentReactionsViewSet(CreateModelMixin,RetrieveModelMixin,UpdateModelMixin,DestroyModelMixin,GenericViewSet):
...
@authentication_classes([TokenAuthentication, BasicAuthentication, SessionAuthentication])
@permission_classes([IsAuthenticated])
class PostsReactionsViewSet(CreateModelMixin,RetrieveModelMixin,UpdateModelMixin,DestroyModelMixin,GenericViewSet):
